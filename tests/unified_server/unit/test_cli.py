...
def test_help_flag_documents_all_flags():
...
def test_help_documents_profile_choices():
...
def test_valid_profile_names_are_accepted():
...
def test_config_valid_toml_file_with_list_services(tmp_path):
...
def test_services_flag_comma_separated_exits_zero():
