...
from panoseti_grpc.generated.daq_data_pb2 import PanoImage, StreamImagesResponse
...
def parse_pano_image(pano_image: daq_data_pb2.PanoImage) -> dict[str, Any]:
    ...
    parsed_pano_image = MessageToDict(
        pano_image, preserving_proto_field_name=True, always_print_fields_with_no_presence=True
    )
