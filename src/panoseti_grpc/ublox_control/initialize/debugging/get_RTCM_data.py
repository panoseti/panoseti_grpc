...
try:
    ...
    with server as gnc:
        streaming = gnc.run(
            server=settingsDict["server"],
            port=settingsDict["port"],
            reflat=settingsDict["reflat"],
            reflon=settingsDict["reflon"],
            ggamode=settingsDict["ggamode"],
            mountpoint=settingsDict["mountpoint"],
            version=settingsDict["version"],
            ntripuser=settingsDict["ntripuser"],
            ntrippassword=settingsDict["ntrippassword"],
            https=settingsDict["https"],
            datatype=settingsDict["datatype"],
            output=data,
        )
