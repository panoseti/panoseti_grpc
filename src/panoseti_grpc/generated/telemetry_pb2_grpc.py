...
def add_TelemetryServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'panoseti.telemetry.Telemetry', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('panoseti.telemetry.Telemetry', rpc_method_handlers)
...
class Telemetry(object):
    ...
    def ReportStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/panoseti.telemetry.Telemetry/ReportStatus',
            telemetry__pb2.StatusRequest.SerializeToString,
            telemetry__pb2.StatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
